      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16'>
          ...
          <Card>
            ...
            <CardContent>
              <p className='text-sm text-muted-foreground'>
                Monitor weight, steps, calories, or any numeric value. See
                averages, min, max, and trends.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className='text-sm text-muted-foreground'>
                Log workout time, study sessions, or any duration. See total and
                average time in HH:MM format.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className='text-sm text-muted-foreground'>
                Monitor daily expenses, savings, or any monetary value. Get
          ...
          <Card>
            ...
            <CardContent>
              <p className='text-sm text-muted-foreground'>
                Automatic calculations, percentages, trends over time. All your
                data visualized beautifully.
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='pt-4 border-t'>
              ...
              <ul className='mt-2 text-sm text-muted-foreground space-y-1'>
                <li>
                  ✓ 5 Tracker Types (Boolean, Number, Text, Duration, Currency)
                </li>
